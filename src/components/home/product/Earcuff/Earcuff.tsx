import EarcuffImageGrid from "@/components/image/product/EarcuffImageGrid";
import Button from "@/components/ui/Button";
import {ProductBlockProps} from "@/components/home/product/types";

const EarcuffArea = ({title, buttonLabel}: ProductBlockProps) => {
  return (
      ...
      <div className="lg:p-2 lg:px-20">
        <div className="p-4 lg:p-6 bg-gray-100 ">
          ...
          <div className="items-center flex justify-center pt-6">
            <Button link="/product#earcuff" label={buttonLabel}/>
          </div>
        </div>
      </div>
    </div>
